 ...
 */
public class SSTableOutput extends BaseTransform implements ITransformMeta<SSTableOutput, SSTableOutputData> {
  ...
  public SSTableOutput( TransformMeta stepMeta, ITransformData stepDataInterface, int copyNr, PipelineMeta transMeta,
      Pipeline trans ) {
