...
import org.apache.hop.di.repository.ObjectId;
import org.apache.hop.di.repository.Repository;
...
public class SSTableOutputMeta extends BaseTransformMeta implements ITransformMeta<SSTableOutput, SSTableOutputData> {
  ...
  public void saveRep( Repository rep, ObjectId id_transformation,
                       ObjectId id_step ) throws HopException {
  ...
  public ITransformMeta getStep( TransformMeta stepMeta,
                                ITransformData stepDataInterface, int copyNr, PipelineMeta transMeta,
                                Pipeline trans ) {
